...
public class CircuitBreakerController {
	...
	//*** Retry - Allows us to configure the retry attempts
	...
	//@Retry(name="sample-api", fallbackMethod = "hardCodedResponse")  // use this name in application.properties to configure retry count ;define public method 'hardCodedResponse'
	...
	//*** Bulkhead - Allows us to configure maximum concurrent calls allowed
	...
	// This method is a fallback method as defined in the @Retry annotation of the sampleAPI() method above
